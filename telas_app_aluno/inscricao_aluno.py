                                    ...
                                    try:
                                        ...
                                        if st.button(
                                            ...
                                            if total < min_e or total > max_e:
                                                st.error(f"⚠️ A equipe deve ter entre {min_e} e {max_e} integrantes. (Atual: {total})")
                                            else:
                                                if novos_membros:
                                                    equipe_final = (
                                                ...
                                                try:
                                                    # Execução da atualização direta no Supabase
                                                    db_provas.table("feira_inscricoes").update(
                                                    ...
                                                    st.error(f"❌ Erro ao salvar no banco: {err_up}")
