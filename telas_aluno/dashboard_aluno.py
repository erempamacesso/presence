...
def mostrar_tela_dashboard(db_alunos, db_provas):
    ...
    # Foco: Botões com cor de fundo destacada e Botão de Iniciar Verde
    # =========================================================
    st.markdown("""
        <style>
        /* Fundo da Página */
        ...
        /* ============================================
           ESTILO DOS BOTÕES DO MENU (ESTADO PARADO)
           Sua ideia: Fundo escuro para destacar do fundo claro!
           ============================================ */
        div[data-testid="stButton"] > button {
            background-color: #4b5563 !important; /* Cinza Escuro - Destaca bem! */
            color: #ffffff !important; /* Texto Branco */
            border: none !important; /* Sem linhas! */
        ...
        /* Efeito ao passar o mouse ou tocar (Menu) */
        div[data-testid="stButton"] > button:hover {
            background-color: #1f2937 !important; /* Fica quase preto */
            transform: scale(0.98);
        }

        /* ============================================
           ESTILO EXCLUSIVO DO BOTÃO DE INICIAR PROVA
           ============================================ */
        .btn-iniciar div[data-testid="stButton"] > button {
            ...
            box-shadow: 0 4px 10px rgba(16, 185, 129, 0.4) !important; /* Sombra verde */
            height: 55px !important;
            border-radius: 8px !important;
        }

        .btn-iniciar div[data-testid="stButton"] > button:hover {
            background-color: #059669 !important; /* Verde mais escuro no clique */
        }

        /* ============================================
           ESTILO EXCLUSIVO DO BOTÃO SAIR
           ============================================ */
    ...
    # =========================================================
    # BLOCO 3: ÁREA DE COMANDOS E BUSCA DE PROVAS
    # =========================================================
    ...
    # --- TELA DE PROVAS (CONECTADA AO BANCO) ---
        ...
        try:
            ...
            if res.data and len(res.data) > 0:
                for prova in res.data:
                    ...
                    # ENVOLVENDO O BOTÃO COM A CLASSE "btn-iniciar" PARA ELE FICAR VERDE
                    ...
                    if st.button("INICIAR AGORA", key=f"start_prova_{prova['id']}", use_container_width=True):
                        # AQUI É O GATILHO PARA O ARQUIVO execucao_prova.py
    ...
    # Aplica o estilo invisível/vermelho apenas no botão sair
