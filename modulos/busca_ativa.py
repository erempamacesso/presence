...
def exibir_busca_ativa(supabase):
            ...
            if res_hist.data:
                ...
                if ranking.empty:
                    ...
                    st.dataframe(
                        ...
                        hide_index=True,
                        column_config={
                            # === AQUI MUDAMOS O TAMANHO DA FOTO DE "small" para "medium" ===
                            "Foto": st.column_config.ImageColumn("📸", width="medium"),
                            "Aluno": st.column_config.TextColumn("Nome do Estudante", width="large"),
                            "turma": st.column_config.TextColumn("Turma", width="small"),
                            "Faltas": st.column_config.ProgressColumn(
                                "🔥 Nível de Alerta",
                                help="Mapa de calor: indica gravidade",
                                format="%d faltas",
                                min_value=0,
                                max_value=5
                            )
    ...
    with aba_mapa:
        ...
        with col_f1:
            ...
            # FORMATO DE DATA CORRIGIDO PARA BRASIL: format="DD/MM/YYYY"
