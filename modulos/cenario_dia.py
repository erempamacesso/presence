...
def exibir_cenario(supabase):
    ...
    # --- 2. TERMÔMETRO DE ASSIDUIDADE (SEM TECLADO) ---
    st.subheader("🌡️ Termômetro de Evolução")
    
    # Trimestre via Botões (Pills) - Não abre teclado
            ...
            if aluno_escolhido != "-- Selecione --":
                ...
                if presencas_tri:
                    ...
                    for _, row in contagem.iterrows():
                        ...
                        # Escala: Verde/Azul para alta frequência (frio), Vermelho para baixa (quente)
